...
-- AddForeignKey
ALTER TABLE `producto_pedido` ADD CONSTRAINT `producto_pedido_producto_id_fkey` FOREIGN KEY (`producto_id`) REFERENCES `producto`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
